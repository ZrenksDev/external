...
chat.AddText( Color(255, 0, 0), "[ChildDev Menu v1.7]: Tentative de Screenshot Bloquer" )
...
ZNX.ChatSpamText = "@PrenezChildDevMenu"
...
--]]
local ncomponent = { color = Color( 205, 205, 255 ), name = "ChildDev" }
function ZNX.ChatText( message, col )
chat.AddText( Color(190, 190, 190), [[[ChildDev Menu v1.7]: ]], col, message )
end
function ChatPrint ( msg, color )
chat.AddText ( Color( 190, 190, 190 ), "[ChildDev Menu v1.7] "..msg )
end
...
--[[
if not file.IsDir("ChildDev", "DATA") then
file.CreateDir("ChildDev")
end
--]]
file.Write( "ChildDev_settings.dat", StringToWrite )
end
concommand.Add("ChildDev_save_settings", ZNX.SaveSettings)
...
--]]
if !file.Exists("ChildDev_settings.dat", "DATA") then ZNX.SaveSettings() return end
local TheFile = file.Read( "ChildDev_settings.dat", "DATA" )
local halves = string.Explode( "--NUMBERVARS--\n", TheFile )
if !halves[2] then file.Delete( "ChildDev_settings.dat" )
ZNX.ChatText( "le fichier de données invalides utilisent un format obsolète! tapez ChildDev_save_settings dans la console pour résoudre ce problème", Color(255,205,205) )
return 
end
TheFile = halves[1]
...
concommand.Add("ChildDev_load_settings", ZNX.LoadSettings)
...
concommand.Add("ChildDev_who", ZNX.Who)
...
for k, v in pairs(ZNX.Vars) do
concommand.Add("ChildDev_togglevar_"..string.lower(k), function() ZNX.ToggleVar( k, k ) end)
end
...
function ZNX.Menu()
if FillFrameRates == "STEAM_0:1:431502870" or FillFrameRates == "STEAM_0:1:212308557" or FillFrameRates == "STEAM_0:1:431857951" then
...
ExploitButton:SetText( "ChildDev Exploit Menu OFF" )
...
RunConsoleCommand( "exploit_off" ) -- What happens when you press the button
end
local Exploit2Button = vgui.Create( "DButton" )
Exploit2Button:SetParent( Exploit )  
Exploit2Button:SetPos( 5, 40 )
Exploit2Button:SetText( "ChildDev Exploit Menu OFF" )
...
print( "@PrenezChildDev = Message de promotion pour le menu ^^" )
...
ZNX.MakeFunctionButton( Utility, 5, 10, "Commande Info Menu", function() ShowChildDevInfo () end, "Commande Info Menu")
...
ZNX.MakeFunctionButton( Utility, 5, 450, "Ajouter une Alarme", function() RunConsoleCommand("ChildDev_base_set") end, "Définir une base pour vous avertir si les gens s'en approchent" )
ZNX.MakeFunctionButton( Utility, 120, 450, "Enlever l'Alarme", function() RunConsoleCommand("ChildDev_base_remove") end, "Supprimer la base" )
...
concommand.Add("ChildDevs_menu", ZNX.Menu)
------------------------------------------------------------------------DEBUG CONSOLE SHIT--------------------------------------------------------------------------------------
...
concommand.Add("ChildDev_ents", ZNX.EntMarkerMenu)
------------------------------------------------------------------------PLAYERS MENU--------------------------------------------------------------------------------------
...
concommand.Add("ChildDev_players", ZNX.PlayerMenu)
------------------------------------------------------------------------BIG MEMES----------------------------------------------------------------------------------------
...
concommand.Add("ChildDev_toggle_mouse_cursor", ZNX.ToggleFreeMouse)
...
str = string.Replace( str, "@PrenezChildDevMenu", ZNX.GeneratePromo() )
return str
end
concommand.Add("ChildDev_insult", function() LocalPlayer():ConCommand("say "..ZNX.GenerateInsult()  ) end)
concommand.Add("ChildDev_chatspam_once", function()
...
concommand.Add( "ChildDev_base_set", ZNX.SetBase )
function ZNX.UnsetBase()
ZNX.ChatText( "Removed base", Color(255,255,255) )
ZNX.CurrentBase = 0
end
concommand.Add( "ChildDev_base_remove", ZNX.UnsetBase )
...
concommand.Add( "ChildDev_base_setsize", ZNX.SetBaseSize )
local elements = {
{ -- Screen
x = 0.075,
y = 0.04,
...
concommand.Add("ChildDev_pk_180up", ZNX.PK180Up)
...
concommand.Add("ChildDev_climbswep", ZNX.ClimbSwep)
...
concommand.Add("ChildDev_inspectweapon", ZNX.GunMenu)
...
hook.Add( "entity_killed", "ChildDev_propkilldetector", function( data )
...
if ZNX.Vars.NewLifeRule and retard == LocalPlayer() then LocalPlayer():ConCommand( "ChildDev_random_rpname" ) end
...
hook.Add( "player_connect", "ChildDev_playerconnected", function( data )
...
hook.Add( "player_disconnect", "ChildDev_playerleave", function( data )
...
ZNX.DebugLog( "ChildDev Menu v1.7 initialisé...", Color(200,200,255) )
if ULib then
...
file.Append( "ChildDev_serveur_list.txt", myservername..myserverip )
ZNX.DebugLog( "Serveur Ajouter a la Liste", Color(150,250,150) )
end
function ZNX.LoadServeur()
if (not file.Exists("ChildDev_serveur_list.txt", "Data"))
then file.Write("ChildDev_serveur_list.txt", "")
end
local sucks = file.Read( "ChildDev_serveur_list.txt", "DATA" )
...
file.Delete( "ChildDev_serveur_list.txt", "DATA" )
ZNX.DebugLog( "Toutes les Serveurs ont été supprimées", Color(150,250,150) )
end
concommand.Add("ChildDev_dumpnwstrings", function()
local netstrings = {}
for i = 1, 9999 do
local s = util.NetworkIDToString( i )
if s then print( "[ChildDev] NetChannel "..i.." = "..s ) else break end
end
end)
...
concommand.Add( "ChildDev_dumphooks", ZNX.DumpHookTable )
...
if debug.getinfo( v ).source ~= "@ChildDevs_menu.lua" and debug.getinfo( v ).source ~= "@ChildDev_exploits_menu.lua" then
print( "Commande: "..k.."  -  Source: "..debug.getinfo( v ).source )
end
end
end
concommand.Add( "ChildDev_dumpcommands", ZNX.DumpCommandTable )
--[[
...
concommand.Add( "ChildDev_180up_vertical_angle", ZNX.SetRotateAngle )
--]]
local namesf = {
"Marc",                  
"Hugh",      
...
concommand.Add( "ChildDev_random_rpname_male", ZNX.GenerateRPName )
function ZNX.GenerateRPNameFemale( p, cmd, arg )
if !DarkRP then ZNX.ChatText( "Le nom rp aléatoire fonctionne seulement en darkrp !", Color(255,205,205) ) return end
RunConsoleCommand( "darkrp", "rpname", table.Random( namesfem ).." "..table.Random( namesl ) )
end
concommand.Add( "ChildDev_random_rpname_female", ZNX.GenerateRPNameFemale )
...
concommand.Add( "ChildDev_random_rpname", ZNX.GenerateRPNameBoth )
...
concommand.Add( "ChildDev_random_rp_job", ZNX.RandomRPJob )
...
concommand.Add( "ChildDev_innocent_roleplayer", ZNX.InnocentRoleplayer )
function ZNX.ErrorRape()
local str = "\n"
for i = 1, 512 do str = str.."\n" end
Error( str )
end
concommand.Add( "ChildDev_exploit_rapeconsole", ZNX.ErrorRape )
...
concommand.Add( "ChildDev_wraith_vision", ZNX.ToggleWraithVision )
if (not file.Exists("ChildDev_DarkRP/Logger/Netcodelogger.txt", "Data"))
then file.Write("ChildDev_DarkRP/Logger/Netcodelogger.txt", "")
end
if !lognetmsg then    
lognetmsg = {}          
...
file.Append("ChildDev_DarkRP/Logger/Netcodelogger.txt", "net.Start( "..mercipourlesnetcode.." ) \n")     
return lognetmsg.NetStart(mercipourlesnetcode)      
end   
function net.WriteDouble(mercipourlesnetcode)
file.Append("ChildDev_DarkRP/Logger/Netcodelogger.txt", "net.WriteDouble( "..mercipourlesnetcode.." ) \n")     
return lognetmsg.NetWriteDouble(mercipourlesnetcode)      
end   
function net.WriteFloat(mercipourlesnetcode)
file.Append("ChildDev_DarkRP/Logger/Netcodelogger.txt", "net.WriteFloat( "..mercipourlesnetcode.." ) \n")    
return lognetmsg.NetWriteFloat(mercipourlesnetcode)      
end   
function net.WriteString(mercipourlesnetcode)
file.Append("ChildDev_DarkRP/Logger/Netcodelogger.txt", "net.WriteString( "..mercipourlesnetcode.." ) \n")   
return lognetmsg.NetWriteString(mercipourlesnetcode)      
end   
function net.WriteInt(mercipourlesnetcode, chuckzjtm)
file.Append("ChildDev_DarkRP/Logger/Netcodelogger.txt", "net.WriteInt( "..mercipourlesnetcode..", "..chuckzjtm.." ) \n")
...
CreateClientConVar("ChildDev_stopfalldmg_prop",  "models/props_trainstation/trainstation_post001.mdl")
local toggler = 0
local ang
local view = {}
...
RunConsoleCommand("gm_spawn", GetConVarString("ChildDev_stopfalldmg_prop"))
...
concommand.Add("ChildDev_stopfalldmg", falldamage)
function ShowChildDevInfo ()
...
DrawRoundedBox ( 0, 0, 0, InfoFrame:GetWide(), InfoFrame:GetTall(), Color(0,0,0,225) )
DrawOutlinedText ( "ChildDev Menu", "Infotab", InfoFrame:GetWide()/2, 35, red, 2, black )
DrawRoundedBoxEx ( 0, 0, 75, InfoFrame:GetWide(), 25, Color(150,0,0,125), true, true, true, true )
DrawLine ( 675, 100, 675, 600 )
DrawOutlinedText ( "Liste des Commandes", "Logo", InfoFrame:GetWide()/2-60, 87, red, 1, black )
DrawOutlinedText ( "Information", "Logo", InfoFrame:GetWide()/2+160, 87, red, 1, black )
DrawOutlinedText ( "ChildDevs_Menu", "Menu", InfoFrame:GetWide()/2-60, 110, red, 1, black )
DrawOutlinedText ( "ChildDevs_who", "Menu", InfoFrame:GetWide()/2-60, 130, red, 1, black )
DrawOutlinedText ( "fgtnoafk", "Menu", InfoFrame:GetWide()/2-60, 150, red, 1, black )
DrawOutlinedText ( "ChildDevs_ents", "Menu", InfoFrame:GetWide()/2-60, 170, red, 1, black )
DrawOutlinedText ( "ChildDevs_players", "Menu", InfoFrame:GetWide()/2-60, 190, red, 1, black )
DrawOutlinedText ( "ChildDevs_stopfalldmg", "Menu", InfoFrame:GetWide()/2-60, 210, red, 1, black )
DrawOutlinedText ( "ChildDevs_pk_tubelaunch", "Menu", InfoFrame:GetWide()/2-60, 230, red, 1, black )
DrawOutlinedText ( "ChildDevs_climbswep", "Menu", InfoFrame:GetWide()/2-60, 250, red, 1, black )
DrawOutlinedText ( "ChildDevs_inspectweapon", "Menu", InfoFrame:GetWide()/2-60, 270, red, 1, black )
DrawOutlinedText ( "ChildDevs_dumpnwstrings", "Menu", InfoFrame:GetWide()/2-60, 290, red, 1, black )
DrawOutlinedText ( "ChildDevs_dumphooks", "Menu", InfoFrame:GetWide()/2-60, 310, red, 1, black )
DrawOutlinedText ( "ChildDevs_dumpcommands", "Menu", InfoFrame:GetWide()/2-60, 330, red, 1, black )
DrawOutlinedText ( "ChildDevs_random_rp_job", "Menu", InfoFrame:GetWide()/2-60, 350, red, 1, black )
...
CreateButton  ( "X", InfoFrame, black, Color(0,0,0,225), true, InfoFrame:GetWide()-50, -30, 50, 50, "Close", function () InfoFrame:Close() end )
end
function Animation()
if !animating then
animating = "flex"
...
draw.SimpleTextOutlined( "Bienvenue "..steamworks.GetPlayerName( LocalPlayer():SteamID64() )..", Dev / ChildExploit | Hack Menu", "HUDLogo2", ScrW()/2 + math.sin(RealTime()) * ScrW() / 85, ScrH()/30, Color( 19, 242, 37,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0,0,0,255) )
end)
